...
:data:`SENSITIVE_FIELDS` in :mod:`social_home.security` — ``email``,
...
class User:
    ...
    them via :data:`social_home.security.SENSITIVE_FIELDS` before returning
...
class UserIdentityAssertion:
    ...
    :func:`social_home.crypto.user_assertion_signed_bytes`.

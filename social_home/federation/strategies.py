...
implicitly inside :mod:`social_home.federation.transport` and
:mod:`social_home.federation.encoder`. By naming them we get:
...
* :class:`social_home.federation.transport.WebhookTransport` →
  :class:`TransportStrategy`
* :class:`social_home.federation.transport._RtcPeer` (channel-level) →
  :class:`TransportStrategy` via :class:`FederationTransport` facade.
* :class:`social_home.federation.encoder.FederationEncoder` →
...
class EncryptionStrategy(Protocol):
    ...
    (:class:`social_home.federation.encoder.FederationEncoder`) uses

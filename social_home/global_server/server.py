...
Console-script entry point: ``social-home-global-server``. Sub-commands:
...
class GfsApp:
    ...
    Mirrors the structure of :func:`social_home.app.create_app` but in
...
def main() -> None:
    """Entry point for the ``social-home-global-server`` console script."""
    logging.basicConfig(
        level=logging.INFO,

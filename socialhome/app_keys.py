...
pending_decrypts_cache_key: AppKey = AppKey("pending_decrypts_cache")
private_invite_handler_key: AppKey = AppKey("private_invite_handler")
...
recovery_kit_service_key: AppKey = AppKey("recovery_kit_service")
recovery_reconnect_service_key: AppKey = AppKey("recovery_reconnect_service")
...
media_transcode_repo_key: AppKey = AppKey("media_transcode_repo")
media_transcode_service_key: AppKey = AppKey("media_transcode_service")
child_protection_service_key: AppKey = AppKey("child_protection_service")
typing_service_key: AppKey = AppKey("typing_service")
preferences_service_key: AppKey = AppKey("preferences_service")
app_service_key: AppKey = AppKey("app_service")
app_federation_service_key: AppKey = AppKey("app_federation_service")
alias_service_key: AppKey = AppKey("alias_service")
alias_resolver_key: AppKey = AppKey("alias_resolver")
...
user_move_service_key: AppKey = AppKey("user_move_service")
...
space_zone_service_key: AppKey = AppKey("space_zone_service")
space_zone_repo_key: AppKey = AppKey("space_zone_repo")
...
#: Per-instance X25519 key-wrap PUBLIC key (raw 32 bytes). Set in
#: ``_on_startup`` from the identity bootstrap; published at GFS
#: registration so a future content-key handoff can seal to us.
instance_keywrap_public_key_key: AppKey[bytes] = AppKey("instance_keywrap_public_key")
#: Ed25519 self-signature (b64url) over the key-wrap pubkey. Set in
#: ``_on_startup``; published at GFS registration so a remote sealer can bind
#: our key-wrap key to our identity end-to-end (``verify_keywrap_binding``).
instance_keywrap_sig_key: AppKey[str] = AppKey("instance_keywrap_sig")
...
space_approval_service_key: AppKey = AppKey("space_approval_service")
...
space_remote_member_repo_key: AppKey = AppKey("space_remote_member_repo")
space_remote_location_repo_key: AppKey = AppKey("space_remote_location_repo")
space_cover_repo_key: AppKey = AppKey("space_cover_repo")
space_icon_repo_key: AppKey = AppKey("space_icon_repo")
...
federation_transport_key: AppKey = AppKey("federation_transport")
peer_user_visibility_repo_key: AppKey = AppKey("peer_user_visibility_repo")
...
highlight_repo_key: AppKey = AppKey("highlight_repo")
highlight_service_key: AppKey = AppKey("highlight_service")
highlight_retention_scheduler_key: AppKey = AppKey("highlight_retention_scheduler")
highlight_publication_service_key: AppKey = AppKey("highlight_publication_service")
moment_repo_key: AppKey = AppKey("moment_repo")
moment_service_key: AppKey = AppKey("moment_service")
moment_retention_scheduler_key: AppKey = AppKey("moment_retention_scheduler")
moment_public_registration_repo_key: AppKey = AppKey("moment_public_registration_repo")
moment_public_follow_repo_key: AppKey = AppKey("moment_public_follow_repo")
moment_public_service_key: AppKey = AppKey("moment_public_service")
moment_public_outbound_key: AppKey = AppKey("moment_public_outbound")
moment_public_inbound_key: AppKey = AppKey("moment_public_inbound")
household_instance_ban_repo_key: AppKey = AppKey("household_instance_ban_repo")
relay_policy_key: AppKey = AppKey("relay_policy")

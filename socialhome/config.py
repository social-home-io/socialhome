...
2. **TOML file** at ``$SH_CONFIG`` or
   ``~/.config/socialhome/socialhome.toml``.
...
DEFAULT_DATA_DIR = f"{_XDG_DATA_HOME}/socialhome"
DEFAULT_CONFIG_DIR = f"{_XDG_CONFIG_HOME}/socialhome"
DEFAULT_DB_FILENAME = "socialhome.db"
DEFAULT_MEDIA_DIR = "media"
DEFAULT_TOML_FILE = f"{DEFAULT_CONFIG_DIR}/socialhome.toml"

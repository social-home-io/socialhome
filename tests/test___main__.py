"""Tests for socialhome.__main__ — verifies the module is importable."""
...
def test_main_module_is_importable():
    """socialhome.__main__ can be imported without side effects."""
    # Remove from cache if already imported to get a fresh import
    mod_name = "socialhome.__main__"
...
def test_main_module_has_expected_contents():
    """socialhome.__main__ imports create_app and Config."""
    import socialhome.__main__ as main_mod
